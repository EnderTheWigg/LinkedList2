...
public class Lab12Tester extends TestCase
{
	public void testAddAndSize()
	{
		//assertTrue(true);
		GenericList<String> list = new MyLinkedList<String>();
	...
	public void testRemoveObject()
	{
		...
		boolean str = list.remove("first");
		assertTrue("Did not remove first element", str);
	...
	public void testSet()
	{
		...
		String obj = list.set(0, "new first");
